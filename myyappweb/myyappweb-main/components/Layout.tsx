...
import { Menu, X, Rocket, Phone, Mail, MapPin, MessageCircle, Sun, Moon, Globe, ChevronDown, Check, ShieldCheck } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-slate-800 mt-12 pt-10">
            <div className="max-w-2xl mx-auto text-center space-y-6">
              <div>
                <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-slate-500 mb-2">Registered Entity</p>
                ...
                <p className="text-slate-500 text-xs sm:text-sm mt-3 leading-relaxed">
                  3/62, Mariamman Koil Street, Sukkampatti,<br />
                  Salem, Tamil Nadu – 636122
                </p>
              </div>

              <div className="flex flex-wrap items-center justify-center gap-x-5 gap-y-2 text-[11px] sm:text-xs text-slate-500 font-medium">
                <span>CIN: U47912TZ2025PTC035024</span>
                <span className="text-slate-700 hidden sm:inline">|</span>
                <span>PAN: AALCV1567F</span>
                <span className="text-slate-700 hidden sm:inline">|</span>
                <span>TAN: CHEV25901B</span>
              </div>

              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-800/60 border border-slate-700/80 text-slate-300 text-xs font-semibold tracking-wide">
                <ShieldCheck className="h-4 w-4 text-emerald-400 flex-shrink-0" />
                DPIIT Certified Company
              </div>

              <p className="text-slate-600 text-xs pt-1">
                © {new Date().getFullYear()} VASANTHATHANGAM PRIVATE LIMITED. All rights reserved.
              </p>
            </div>
          </div>
        </div>
