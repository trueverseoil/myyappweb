...
import { Mail, Phone, MapPin, Send, MessageCircle, AlertCircle, ShieldCheck, Building2 } from 'lucide-react';
  ...
  return (
    <div className="pt-24 pb-20 bg-white dark:bg-slate-950 transition-colors">
      <SEO 
        ...
        description="Ready to scale your business? Contact Myyapp in Salem, Tamil Nadu for expert advice on web development, mobile apps, and viral marketing strategies for Indian businesses."
      />
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-base text-slate-900 dark:text-white font-medium leading-relaxed">
                      3/62, Mariamman Koil Street,<br />
                      Sukkampatti, Salem – 636122,<br />
                      Tamil Nadu
                    </p>
                  </div>
                </div>
                ...
                <div className="pt-6 mt-2 border-t border-slate-200 dark:border-slate-700">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <p className="text-xs font-semibold uppercase tracking-wider text-slate-500">Corporate Details</p>
                  </div>
                  <p className="text-sm font-semibold text-slate-900 dark:text-white mb-3">
                    VASANTHATHANGAM PRIVATE LIMITED
                  </p>
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs text-slate-600 dark:text-slate-400">
                    <div className="bg-white dark:bg-slate-800 rounded-lg px-3 py-2 border border-slate-100 dark:border-slate-700">
                      <span className="block text-[10px] uppercase tracking-wider text-slate-400 mb-0.5">CIN</span>
                      U47912TZ2025PTC035024
                    </div>
                    <div className="bg-white dark:bg-slate-800 rounded-lg px-3 py-2 border border-slate-100 dark:border-slate-700">
                      <span className="block text-[10px] uppercase tracking-wider text-slate-400 mb-0.5">PAN</span>
                      AALCV1567F
                    </div>
                    <div className="bg-white dark:bg-slate-800 rounded-lg px-3 py-2 border border-slate-100 dark:border-slate-700">
                      <span className="block text-[10px] uppercase tracking-wider text-slate-400 mb-0.5">TAN</span>
                      CHEV25901B
                    </div>
                  </div>
                  <div className="mt-4 inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 text-emerald-700 dark:text-emerald-400 text-xs font-semibold">
                    <ShieldCheck className="h-3.5 w-3.5 flex-shrink-0" />
                    DPIIT Certified Company
                  </div>
                </div>
              </div>
            </div>
