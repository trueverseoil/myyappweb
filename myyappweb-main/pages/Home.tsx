...
export const Home: React.FC = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      content: "Best development team in Salem. They understood our MVP requirements perfectly and delivered on time. The Wiral integration is a bonus!",
  ...
  const whyChooseUsData = [
    ...
    {
      title: 'Local Support',
      desc: 'Based in Salem, Tamil Nadu with a pan-India vision. We understand local market nuances and provide support in multiple Indian languages.',
